...
Contiene: título, indicador de modo, botón Vista Dual y avatar/configuración.
"""
...
class Header(tk.Frame):
    ...
    Altura: 56px | Fondo: surface_container (#f0edec)
    """
    ...
    def _build(self):
        ...
        # Ícono decorativo (cuadro burdeos)
        ...
        # ── Centro: Indicador de Modo ───────────────────────────────────────────
        center = tk.Frame(self, bg=C["surface_container"])
        center.pack(side="left", expand=True)

        mode_pill = tk.Frame(center, bg=C["surface_high"], bd=0)
        mode_pill.pack()
        tk.Label(
            mode_pill,
            text="  MODO NORMAL  ",
        ...
        mode_pill.configure(highlightbackground=C["outline_variant"], highlightthickness=1)
